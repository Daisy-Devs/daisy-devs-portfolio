    ...
    <section className="mx-auto px-margin-desktop mb-30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
        ...
        <div className="bg-surface-container border-2 border-on-background rounded-[30px] p-10 hover-drop transition-all">
          <div className="flex flex-col sm:flex-row justify-between items-start mb-6">
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-on-surface-variant">
                <Clock3 size={20} className=" text-xs inline" /> 5-6 weeks
              </div>
            </div>
          </div>
          <ul className="space-y-4 mb-8">
            <li className="flex items-center gap-3">
              <CircleCheck className=" text-secondary align-middle text-lg" />{" "}
              Online ordering &amp; Loyalty
            </li>
            <li className="flex items-center gap-3">
              <CircleCheck className=" text-secondary align-middle text-lg" /> 2
          ...
          <Button
            onClick={() => {
              setEnquiryFormShown(true);
              setSelectedPackage("Standard App");
            }}
            variant={"tertiary"}
          >
            Go Mobile
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start mb-6">
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-on-tertiary-container">
                <Clock3 size={20} className=" text-xs inline" /> 6-8 weeks
              </div>
            </div>
          </div>
          <ul className="space-y-4 mb-8">
            <li className="flex items-center gap-3 font-bold">
              <CircleCheck className="text-secondary text-lg" /> Everything in
              Standard
            </li>
            <li className="flex items-center gap-3 ">
              <CircleCheck className="text-secondary text-lg" /> Admin + User
              Apps
            </li>
            <li className="flex items-center gap-3">
              <CircleCheck className="text-secondary text-lg" /> In-app chat
              support
            </li>
            <li className="flex items-center gap-3">
              <CircleCheck className="text-secondary text-lg" /> 1 Year Support
              Incl.
            </li>
          </ul>
          <Button
            onClick={() => {
              setEnquiryFormShown(true);
              setSelectedPackage("Premium App");
            }}
            variant="secondary"
          >
            Go Premium
